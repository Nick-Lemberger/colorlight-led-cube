...
module top
    ...
    liteeth_core ethernet (
        ...
        /* output        */ .rgmii_clocks_tx      (rgmii_tx_clk         ),
        /* input         */ .rgmii_clocks_rx      (rgmii_rx_clk         ),
        /* output        */ .rgmii_rst_n          (                     ),
        /* input         */ .rgmii_int_n          (                     ),
        /* inout         */ .rgmii_mdio           (                     ),
        /* output        */ .rgmii_mdc            (                     ),
        /* input         */ .rgmii_rx_ctl         (rgmii_rx_ctl         ),
        /* input  [3:0]  */ .rgmii_rx_data        (rgmii_rxd            ),
        /* output        */ .rgmii_tx_ctl         (rgmii_tx_ctl         ),
        /* output [3:0]  */ .rgmii_tx_data        (rgmii_txd            ),
